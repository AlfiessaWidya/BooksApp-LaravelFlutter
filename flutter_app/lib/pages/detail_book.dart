                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image: NetworkImage("http://192.168.56.1:8000/uploads/"+widget.articleInfo.img),
                              fit: BoxFit.fill,
                            ),
                          ),
                        ),
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            TextWidget(text: widget.articleInfo.author, fontSize: 18, color: Color(0xFF7b8ea3)),
                            Divider(color: Colors.grey),
                            TextWidget(text: widget.articleInfo.description, fontSize: 12, color: Color(0xFF7b8ea3)),
                          ],
                        ),
                      )
                    ],
